        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Enter your email or phone number to make your company&apos;s money go further with
              Expensify&apos;s time-saving spend management tools.
            </p>
          </div>
          ...
          <div className="lg:w-1/2 flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              />
              <button type="button" className="btn-green px-6 py-3 text-sm rounded-full whitespace-nowrap">
                Get Started
              </button>
            </div>
